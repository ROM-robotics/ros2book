...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<rom_msgs::srv::AddThreeInts>::SharedPtr client =
    node->create_client<rom_msgs::srv::AddThreeInts>("add_three_ints");

  auto request = std::make_shared<rom_msgs::srv::AddThreeInts::Request>();
